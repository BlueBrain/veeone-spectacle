...
export class JsonRPCRequest {
    ...
    constructor(public readonly method: string, public readonly params?: Json, id?: string) {
...
export class JsonRPCResponse {
    ...
    constructor(public readonly id: string, public readonly result?: Json, public readonly error?: Json) {
    }

    static readonly validateJsonRPCResponseFormat = (data: JsonRPCResponseData) => {
    ...
    static readonly createFromString = (data: string): JsonRPCResponse => {
        ...
        const jsonData: JsonRPCResponseData = JSON.parse(data) as JsonRPCResponseData
        const {id, result, error} = JsonRPCResponse.validateJsonRPCResponseFormat(jsonData)
